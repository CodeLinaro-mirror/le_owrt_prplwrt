...
Check correct interface setup:
  ...
  $ R "ip link | grep ^\\\\d | cut -d: -f2-" | LC_ALL=C sort
   ...
   lan3@eth1: <BROADCAST,UP,LOWER_UP> mtu 1500 qdisc noqueue master br-lan state UP mode DEFAULT group default qlen 1000
   ...
   wlan1: <NO-CARRIER,BROADCAST,MULTICAST,UP> mtu 1500 qdisc noqueue state DOWN mode DEFAULT group default qlen 1000