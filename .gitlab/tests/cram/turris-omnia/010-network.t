...
Check correct interface setup:
  ...
  $ R "ip link | grep ^\\\\d | cut -d: -f2-" | LC_ALL=C sort
   ...
   eth2: <BROADCAST,MULTICAST,UP,LOWER_UP> mtu 1500 qdisc htb state UP mode DEFAULT group default qlen 532
   ...
   wlan0.2: <NO-CARRIER,BROADCAST,MULTICAST,UP> mtu 1500 qdisc noqueue state DOWN mode DORMANT group default qlen 1000
