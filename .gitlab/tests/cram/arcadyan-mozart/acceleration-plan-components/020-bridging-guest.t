...
Remove eth1 from LAN bridge and add it to the Guest bridge:
  ...
  > ubus-cli Bridging.Bridge.guest.Port.+{Name="eth1", Alias="ETH1", LowerLayers="Device.Ethernet.Interface.2."}\n
  > sleep 1\n
...
Remove eth1 from the Guest bridge and add it back to the LAN bridge:
  ...
  > ubus-cli Bridging.Bridge.lan.Port.+{Name="eth1", Alias="ETH1", LowerLayers="Device.Ethernet.Interface.2."}\n
  > sleep 1\n
