...
Check that Rlyeh can download testing container:
  ...
  $ R "ubus -S call Rlyeh pull '{\"URI\":\"docker://registry.gitlab.com/prpl-foundation/prplos/prplos/prplos-testing-container-intel_mips-xrx500:v1\",\"DUID\":\"8c7fdf72-d188-4660-a660-8a78de4f4d15\"}'"
  {"retval":""}
  {}
  {"amxd-error-code":0}
...
Remove testing container:
  ...
  $ R "ubus -S call Rlyeh remove '{\"DUID\":\"8c7fdf72-d188-4660-a660-8a78de4f4d15\",\"Version\":\"v1\"}'"; sleep 5
  {"retval":""}
  {}
  {"amxd-error-code":0}
