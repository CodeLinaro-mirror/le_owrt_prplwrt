...
Remove cpe-dhcpv4s-lan rule:
  ...
  $ script --command "ssh -t root@$TARGET_LAN_IP ubus-cli Firewall.Service.cpe-dhcpv4s-intf-3-" > /dev/null; sleep .5
...
Add back firewall rule for cpe-dhcpv4s-lan access from LAN:
  ...
  $ printf "\
  > ubus-cli Firewall.Service+{Alias='cpe-dhcpv4s-intf-3'}
  > ubus-cli Firewall.Service.cpe-dhcpv4s-intf-3.Action=Accept
  > ubus-cli Firewall.Service.cpe-dhcpv4s-intf-3.DestPort=67
  > ubus-cli Firewall.Service.cpe-dhcpv4s-intf-3.IPVersion=4
  > ubus-cli Firewall.Service.cpe-dhcpv4s-intf-3.Interface=Device.IP.Interface.3.
  > ubus-cli Firewall.Service.cpe-dhcpv4s-intf-3.Protocol=17
  > ubus-cli Firewall.Service.cpe-dhcpv4s-intf-3.Enable=1
  > " > /tmp/cram
