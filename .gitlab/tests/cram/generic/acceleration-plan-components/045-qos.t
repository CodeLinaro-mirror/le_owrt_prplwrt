...
Check QoS.QueueStats datamodel for stats-home-iptv:
  ...
  $ R "ba-cli -l 'QoS.QueueStats.4.Status?;QoS.QueueStats.4.QueueOccupancyPercentage?;QoS.QueueStats.4.Alias?;QoS.QueueStats.4.Queue?' | grep -v '^$' | sort"
  0
  Enabled
...
Check DSCP value for IPv4 ICMP packets with icmp_dscp_cs6 classification configuration:
  ...
  $ sleep 1
  $ R "ba-cli -l 'QoS.Classification.1.Status?;QoS.Classification.1.DSCPMark?;QoS.Classification.1.Alias?;QoS.Classification.1.Protocol?;QoS.Classification.1.IPVersion?' | grep -v '^$' | sort"
  1
  4
  48
  Enabled
