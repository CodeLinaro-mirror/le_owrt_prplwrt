...
Added delay before PrplMesh resuming to avoid a race condition where beerocks_agent fails to read wlanX parameters from the DM:
...
Wait 30s before leaving the test:
