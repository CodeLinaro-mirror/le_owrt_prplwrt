...
Check that we've WPS gpio key available:
  ...
  $ R "cat /sys/firmware/devicetree/base/soc@0/gpio_keys_polled/button@1/label"
  wps\x00 (no-eol) (esc)

  $ R "hexdump -s2 -n2 -e '1/1 \"0x%02x \"' /sys/firmware/devicetree/base/soc@0/gpio_keys_polled/button@1/linux,code"
  0x02 0x11  (no-eol)
