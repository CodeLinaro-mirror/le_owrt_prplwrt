...
Install testing prplOS container v1:
  ...
  > URL="docker://registry.gitlab.com/prpl-foundation/prplos/prplos/prplos/lcm-test-x86-64-v1:ynezz-lcm-containers", \
...
Update to prplOS container v2:
  ...
  > URL="docker://registry.gitlab.com/prpl-foundation/prplos/prplos/prplos/lcm-test-x86-64-v2:ynezz-lcm-containers", \
  > ExecutionEnvRef="generic", \
  > NetworkConfig = { "AccessInterfaces" = [{"Reference" = "Lan"}] } \
  > \)
  > EOF
