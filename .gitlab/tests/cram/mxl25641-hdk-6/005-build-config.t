...
Assure expected build configuration (PCF-1413):
  ...
  CONFIG_SAH_SERVICES_GMAP-MIBS-COMMON_INFORMATION=y
  CONFIG_SAH_SERVICES_GMAP-MIBS-COMMON_LOCATION=y
  CONFIG_SAH_SERVICES_GMAP-MIBS-COMMON_PRIORITY=y
  CONFIG_SAH_SERVICES_GMAP-MIBS-COMMON_WAN-ACCESS=y
