...
Assure expected build configuration (PCF-1413):
  ...
  CONFIG_PACKAGE_datacollect-agent=y
  ...
  CONFIG_SAH_DATACOLLECT_AGENT=y
  CONFIG_SAH_DATACOLLECT_AGENT_START_ORDER=95
  CONFIG_SAH_DATACOLLECT_AGENT_STOP_ORDER="05"
  CONFIG_SAH_DATACOLLECT_PERSIST_PATH="/etc/config/datacollect/agent"
