...
Set AutoChannelEnable=0 on all WiFi.Radio. interfaces:
  ...
  [{"Device.WiFi.Radio.1.":{"AutoChannelEnable":0},"WiFi.Radio.2.":{"AutoChannelEnable":0},"Device.WiFi.Radio.3.":{"AutoChannelEnable":0}}]
...
Next, restore security modes in two steps: WPA3 Transition to 2.4GHz/5GHz, and WPA3 Personal to 6GHz
  ...
  $ R "usp-cli -j -l Device.WiFi.AccessPoint.2.Security.ModeEnabled='WPA2-WPA3-Personal' | jsonfilter -e @[0]'[@].ModeEnabled'"
  WPA2-WPA3-Personal
