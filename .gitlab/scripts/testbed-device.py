...
class TestbedDevice:
    ...
    def _init_lan_vlan(self):
        ...
        self.shell.run("ubus-cli Bridging.Bridge.1.VLANPort+{Alias='LAN', Name='vlan201', Port='Device.Bridging.Bridge.1.Port.2.', VLAN='Device.Bridging.Bridge.1.VLAN.1.', Enable=1}")
