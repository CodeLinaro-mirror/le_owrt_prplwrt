...
LOG_COMMANDS = \
    [
        ...
        LogCommand('ba-cli "IP.?"', "dm-IP.txt"),
        LogCommand('ba-cli "Bridging.?"', "dm-Bridge.txt"),
        LogCommand('ba-cli "Ethernet.?"', "dm-Ethernet.txt"),
        LogCommand('ba-cli "DHCPv4Client.?;DHCPv4Server.?"', "dm-DHCPv4.txt"),
        LogCommand('ba-cli "DHCPv6Client.?;DHCPv6Server.?"', "dm-DHCPv6.txt"),
        LogCommand('ba-cli "Firewall.?"', "dm-Firewall.txt"),
        LogCommand('ba-cli "WiFi.?"', "dm-WiFi.txt"),
